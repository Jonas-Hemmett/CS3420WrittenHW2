...
// example of a mutex lock and a shared buffer
...
void *consumer(void *param) {
  ...
  while ( ! done ) {
    ...
    // waste a little time: just to emphasize that producer and
    // consumer are independent and must coordinate their actions
